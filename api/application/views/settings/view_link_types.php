                    ...
                    <div class="content dashboard_v4_project_list">
                        <div class="dashboard-content">
                            <div class="dashboard-header">
                                ...
                                <!--<span style="float:right;margin-right: 2%;"><button class="btn btn-warning" onclick="exportData('myDataTable', 'link_types.xls')">Export to Excel</button></span>-->
                            </div>
                            <div class="dashboard-box">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="basic_table table-responsive">
                                            <table class="table table-striped" style="width: 30% !important;padding: 0px !important;">
                                                <thead>
                                                    <tr >
                                                        <th>#</th>
                                                        <th ng-click="orderByField = 'name'; reverseSort = !reverseSort" style="cursor: pointer !important;">Link Type
                                                ...
                                                <tbody>
                                                    <tr ng-repeat="links in linkTypes| orderBy:orderByField:reverseSort |  filter: searchfield track by $index">
                                                        <td>{{ $index + 1}}</td>
                                                        <td ng-click="editLinkType(links, $index)"><span ng-hide="links.editMode">{{ links.name}}</span>
                                                        <input type="text" ng-show="links.editMode" class="form-control" id="exampleInputuname_3" ng-model="links.name" >
                                                        </td>
                                                        <td>
                                                            <button style="padding:5px 5px !important;" ng-hide="links.editMode" class="btn btn-mini btn-primary" ng-click="editLinkType(links, $index)" ><i class="fa fa-edit"></i></button>
                                                            <button style="padding:5px 5px !important;" ng-hide="links.editMode" class="btn btn-mini btn-danger" ng-click="deleteLinkType(links.id, $index)" id="sa-warning"><i class="fa fa-close"></i></button>
                                                            <button style="padding:5px 5px !important;" ng-show="links.editMode" class="btn btn-xs btn-primary" ng-click="updateLinkType(links)" >Update</button>
                                                            <button style="padding:5px 5px !important;" ng-show="links.editMode" class="btn btn-xs btn-danger" ng-click="cancelLinkType(links)" id="sa-warning">Cancel</button>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
